...
function CanvasDesigner () {
  ...
  let syncDataListener = function (data) { }
  let dataURLListener = function (dataURL) { }
  let captureStreamCallback = function () { }
  ...
  designer.appendTo = function (parentNode, callback) {
    ...
    designer.iframe.id = 'FaceToFace-iframe'
